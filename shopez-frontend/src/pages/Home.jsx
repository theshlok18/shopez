...
export default function Home() {
  ...
  return (
    <div className="overflow-hidden">
      ...
      <section className="relative min-h-[90vh] warm-gradient flex items-center justify-center overflow-hidden">
        {/* Floating shapes */}
        <div className="absolute inset-0 overflow-hidden">
          <div className="absolute top-20 left-10 w-72 h-72 bg-white/10 rounded-full blur-3xl float"></div>
          <div className="absolute bottom-20 right-10 w-96 h-96 bg-rose-300/20 rounded-full blur-3xl float" style={{animationDelay: '1s'}}></div>
          <div className="absolute top-1/2 left-1/3 w-64 h-64 bg-amber-300/20 rounded-full blur-3xl float" style={{animationDelay: '2s'}}></div>
        </div>
        ...
        <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          <div className="glass rounded-3xl p-8 md:p-16 max-w-4xl mx-auto">
            ...
            {isAuthenticated ? (
              <Link to="/products" className="inline-flex items-center gap-2 bg-white text-rose-500 px-10 py-4 rounded-2xl font-bold text-lg hover:bg-rose-50 transition-all duration-300 shadow-2xl hover:shadow-rose-500/25 hover:scale-105">
              ...
              <div className="flex flex-col sm:flex-row gap-4 justify-center">
                <Link to="/login" className="inline-flex items-center gap-2 bg-white text-rose-500 px-8 py-4 rounded-2xl font-bold text-lg hover:bg-rose-50 transition-all duration-300 shadow-2xl hover:shadow-rose-500/25 hover:scale-105">
                  <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M11 16l-4-4m0 0l4-4m-4 4h14m-5 4v1a3 3 0 01-3 3H6a3 3 0 01-3-3V7a3 3 0 013-3h7a3 3 0 013 3v1" />
                  </svg>
                  Login
                </Link>
                <Link to="/register" className="inline-flex items-center gap-2 bg-gradient-to-r from-teal-400 to-emerald-400 text-white px-8 py-4 rounded-2xl font-bold text-lg hover:from-teal-500 hover:to-emerald-500 transition-all duration-300 shadow-2xl hover:shadow-emerald-500/25 hover:scale-105">
                  <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
      ...
      <section className="py-24 bg-white relative overflow-hidden">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative">
          <div className="text-center mb-16">
            ...
            <h2 className="section-title mb-6">About ShopEZ</h2>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            {[
              ...
              <div key={idx} className="card-gradient group cursor-pointer">
                ...
                <h3 className="text-2xl font-bold text-slate-800 mb-3 text-center">{feature.title}</h3>
          ...
          <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 relative">
            <div className="relative overflow-hidden rounded-3xl shadow-2xl">
              ...
              <div className="relative glass p-10 md:p-16 text-center">
                ...
                <div className="flex flex-col sm:flex-row gap-4 justify-center">
                  <Link to="/login" className="inline-flex items-center justify-center gap-2 bg-white text-rose-500 px-10 py-4 rounded-2xl font-bold text-lg hover:bg-rose-50 transition-all duration-300 shadow-xl hover:shadow-2xl hover:scale-105">
                    <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                      <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M11 16l-4-4m0 0l4-4m-4 4h14m-5 4v1a3 3 0 01-3 3H6a3 3 0 01-3-3V7a3 3 0 013-3h7a3 3 0 013 3v1" />
                    </svg>
                    Login to Your Account
                  </Link>
                  <Link to="/register" className="inline-flex items-center justify-center gap-2 bg-gradient-to-r from-teal-400 to-emerald-400 text-white px-10 py-4 rounded-2xl font-bold text-lg hover:from-teal-500 hover:to-emerald-500 transition-all duration-300 shadow-xl hover:shadow-2xl hover:scale-105">
                    <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                      <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M18 9v3m0 0v3m0-3h3m-3 0h-3m-2-5a4 4 0 11-8 0 4 4 0 018 0zM3 20a6 6 0 0112 0v1H3v-1z" />
                    </svg>
                    Create New Account
