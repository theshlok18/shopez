      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex justify-between items-center h-18 py-2">
          <Link to="/" className="flex items-center space-x-3 group">
            <div className="w-12 h-12 bg-gradient-to-br from-rose-400 via-orange-400 to-amber-400 rounded-2xl flex items-center justify-center shadow-lg group-hover:shadow-rose-400/50 group-hover:scale-110 transition-all duration-300">
          ...
          <div className="hidden md:flex items-center space-x-1">
            {!isAuthenticated && (
              <Link to="/" className="px-4 py-2 text-slate-600 hover:text-rose-500 hover:bg-rose-50 rounded-xl transition-all duration-200 font-medium">
                Home
              </Link>
            )}
            ...
            {isAuthenticated ? (
              <>
                <Link to="/products" className="px-4 py-2 text-slate-600 hover:text-rose-500 hover:bg-rose-50 rounded-xl transition-all duration-200 font-medium">
                  Products
                </Link>
                <Link to="/orders" className="px-4 py-2 text-slate-600 hover:text-rose-500 hover:bg-rose-50 rounded-xl transition-all duration-200 font-medium">
                  Orders
                </Link>
                {hasRole('ROLE_ADMIN') && (
                  <Link to="/admin" className="px-4 py-2 text-slate-600 hover:text-purple-500 hover:bg-purple-50 rounded-xl transition-all duration-200 font-medium">
                    Admin Dashboard
                  </Link>
                )}
              </>
              ...
              <>
                ...
                <div className="relative group">
                  <button className="flex items-center space-x-2 p-1.5 pr-4 text-slate-600 hover:text-rose-500 hover:bg-rose-50 rounded-full transition-all duration-200">
                    <div className="w-9 h-9 bg-gradient-to-r from-rose-400 to-orange-400 rounded-full flex items-center justify-center shadow-md">
